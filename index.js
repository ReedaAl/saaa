...
client.on('ready', () => {
	...
	client.user.setActivity(`${prefix}help`, { type: 'Playing' }); ///التعديل علي البلاينج
});
...
> _Pause : ايقاف مؤقت الاغنية  
> _Resume : اكمال الاغنية 
> _stop : لأيقاف الأغنية وخروج البوت من الروم
> _forceskip : لتخطي الأغنية بشكل مباشر
> _Queue : عرض القائمة 
> _skipto : لتخطي الأغنية الى الأغنية القادمة في طابور الموسيقى القادمة
> _Skip : تخطي للاغنية التالية 
> _Volume : تغيير الصوت [vol] 
> _Nowplaying : عرض مايتم تشغيله الان [np] 
> _Ping : سرعة استجابة البوت 
> _repeat : تكرار الاغنية 
> _Leave : الخروج من الروم الصوتي
> _link  : يرسلك رابط البوت   
